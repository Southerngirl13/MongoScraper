...
$(document).ready(function() {
    ...
    // Adding event listerners for dynamically generated buttons for deleting articles,
    ...
    function renderArticles(articles) {
        // This function handles appending HTML containing our artile data to the page
        // We are passed an array of JSON containing all available articles in our database
        var articlePanels = [];
        // We pass eacch article JSON object to the createPanel function which returns a bootstrap panel with our article data inside
    ...
    // We attach the article's id to the jQuest element
    //We will use this when trying to figure out which article the user
    //notes for
    ...
    function renderEmpty() {
        // This function renders some HTML to the page explaining we don't have
        // Using a joined array of HTML string data because it's easier to rea...... concatenated string
        var emptyAlert = 
...
function handleArticleNotes() {
    // This function handles apending the notes modal and displaying our notes
    // We grab the id of the article to get notes from the panel element the delete button sits inside
    var currentArticle = $(this).parents(".panel").data();
    // Grab any notes with this deadline/article id
    $.get("/api/notes/" + currentArticle._id).then(function(data) {
        ...
        // Addint the formatted HTML to the note modal
        bootbox.dialog({
            message: modalText,
            closeButton: true
        });
        ...
        // Adding some information about the articl and article notes to the save button for easy access
        // When trying to add a new note
        $(".btn.save").data("article", noteData);
        // renderNotesList will populate the actual note HTML insid of the modal that was just created/opened
